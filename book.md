...
### Базовый Lock блокировка в threading
```python
import asyncio
import requests
...
Такой код будет в отдельных потоках выполнять запросы, а в главном потоке использовать сопрограмму *reporter* для печати статистики